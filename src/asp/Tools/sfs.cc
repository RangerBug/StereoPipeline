...
void handle_arguments(int argc, char *argv[], Options& opt) {
  ...
  general_options.add_options()
    ...
    ("reflectance-type", po::value(&opt.reflectance_type)->default_value(1),
     "Reflectance type: 0 = Lambertian, 1 = Lunar-Lambert, 2 = Hapke, 3 = Experimental extension of Lunar-Lambert, 4 = Charon model (a variation of  1 = Lunar-Lambert, 2 = Hapke, 3 = Experimental extension of Lunar-Lambert, 4 = Charon model (a variation of Lunar-Lambert), 5 = MMPF model (Mean Moon Photometric Function).")
...
int main(int argc, char* argv[]) {
  ...
  Options opt;
  try {
    std::cout << "Welcome to Willie's Version\n" << std::endl;
